  ...
  <div class="card"> 
      <div class="card-header"> 
        ...
        <div class="card-tools"> 
          <button onclick="modalAction('{{ url('user/create_ajax') }}')" class="btn btn-sm btn-success mt-1">Tambah Data User</button>
          <button onclick="modalAction('{{ url('user/import') }}')" class="btn btn-sm btn-info mt-1">
            <i class="fa fa-file-excel mr-1"></i>Import Data User
          </button>
